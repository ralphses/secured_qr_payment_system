...
<body>
        ...
        <div class="flex flex-col h-full divide-y-2 divide-gray-200">
            ...
            <div class="p-6 overflow-scroll h-full">
                <ul class="navbar-nav flex flex-col gap-2" data-fc-type="accordion">
                    <!-- Home Page Link -->
                    <li class="nav-item">
                        <a href="{{ route('dashboard') }}" class="nav-link"><span class="shrink-0 me-2">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>Stockholm-icons / Layout / Layout-4-blocks</title>
                                    <desc>Created with Sketch.</desc>
                            ...
                            <span class="shrink-0 me-2">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    ...
                                    <g id="Stockholm-icons-/-Media-/-Equalizer" stroke="none" stroke-width="1"
                                        fill="none" fill-rule="evenodd">
                                        <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                        <rect id="Rectangle-62-Copy" fill="currentColor" opacity="0.3" x="13" y="4"
                                            width="3" height="16" rx="1.5"></rect>
                                        <rect id="Rectangle-62-Copy-2" fill="currentColor" x="8" y="9" width="3"
            ...
            <div class="px-6 py-4 flex items-center">
                <button
                    class="bg-primary w-full text-white p-3 rounded flex items-center justify-center text-sm">Download</button>
            </div>
        </div>
    </div>
    <!-- =========== Mobile Menu End =========== -->
        ...
        <section class="relative overflow-hidden">
            <div class="container">
                <div class="flex items-center justify-between my-6">
                    <div class="">
                        <h4 class="text-base text-gray-800">My Recent QR codes</h4>
                    </div>
                    <div class="">
                        <!-- Anchor tag to create a new QR code -->
                        <a href="{{ route('create.qrcode') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded">Create New QR Code</a>
                    </div>
                ...
                <table class="w-full border-collapse border border-gray-300">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="p-3 text-left">QR Code Image</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($codes as $code)
                            <tr>
                                <td class="p-3">
                                    <!-- QR Code Image here -->
                                    <img src="{{ $code['link'] }}" alt="QR Code Image" class="w-8 h-8" id="{{ $code['reference'] }}">
                                </td>
                                <td class="p-3">
                                    <!-- Date Created information here -->
                                    <span class="text-sm text-gray-700">{{ $code['createdAt'] }}</span>
                                </td>
                                <td class="p-3">
                                    <!-- Description information here -->
                                    <span class="text-sm font-semibold text-gray-700">{{ $code['itemName']}}</span>
                                </td>
                                <td class="p-3">
                                    <!-- Total Amount information here -->
                                    <span class="text-sm font-semibold text-green-500">{{ $code['amount'] }}</span>
                                </td>
                                <td class="p-3">
                                    <!-- Actions information here -->
                                    <button onclick="downloadQRCode('{{ $code['reference'] }}')" class="bg-green-500 hover:bg-blue-600 text-white px-2 py-1 rounded">Download</button>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="flex items-center flex-wrap">
                <div class="grow">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="inline-flex items-center"><a href="#">Support <i
                                    class="fa-solid fa-minus text-sm"></i></a></div>
                        <div class="inline-flex items-center"><a href="#">Careers<span
                                    class="inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-semibold bg-green-500/10 text-green-500">We're
                                    hiring</span></a></div>
                    </div>
                </div>
                <div class="shrink md:text-end mt-4 lg:mt-0">
                    <p class="text-sm mb-0">
                        ...
                        </script> © Prompt. All rights reserved. Crafted by <a
                            href="https://coderthemes.com/">Coderthemes</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <script>
        function downloadQRCode(ref) {
            ...
            var qrCodeImage = document.getElementById(ref);

            // Create a temporary anchor element
            var a = document.createElement('a');

            // Set the download attribute and create a Blob with the image data
