...
<head>
    <meta charset="utf-8" />
    <title>Mobile Application Landing Page | Prompt - Tailwind CSS Multipurpose Landing Page Template</title>
                       ...
                       <div id="landingDropdownMenu"
                               ...
                               <a class="nav-link p-3 hover:bg-slate-100" href="#">
                                   <div class="flex items-center -ms-1.5">
                                       ...
                                       <div class="flex-grow-1">
                                           <p class="text-xs/none">New User Registered</p>
                                           <span class="text-gray-400 text-xs"><small>2 min ago</small></span>
                                       </div>
                                   </div>
                               </a>
                           </div>
                           <div class="nav-item">
                               <a class="nav-link p-3 hover:bg-slate-100" href="#">
                                   <div class="flex items-center -ms-1.5">
                                       <span
                                           class="bg-orange-400/10 text-orange-400 flex justify-center items-center w-8 h-8 shadow rounded me-3">
                                           <svg width="24px" height="24px" viewBox="0 0 24 24"
                                               version="1.1" xmlns="http://www.w3.org/2000/svg"
                                               xmlns:xlink="http://www.w3.org/1999/xlink"><!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                                               <title>Stockholm-icons / Communication / Chat-check</title>
                                               <desc>Created with Sketch.</desc>
                                               <g id="Stockholm-icons-/-Communication-/-Chat-check"
                                                   ...
                                                   <path
                                                       ...
                                                       id="check" fill="currentColor" opacity="0.3"></path>
                                                   <path
                                   ...
                                   <div class="flex items-center -ms-1.5">
                                       <span
                                           ...
                                           <svg width="24px" height="24px" viewBox="0 0 24 24"
                                               ...
                                               <desc>Created with Sketch.</desc>
                                               <g id="Stockholm-icons-/-Communication-/-Mail-attachment"
                                                   stroke="none" stroke-width="1" fill="none"
                                                   fill-rule="evenodd">
                                                   <rect id="bound" x="0" y="0" width="24"
                                                       height="24"></rect>
                           ...
                           <div class="nav-item">
                               <a class="nav-link p-3 hover:bg-slate-100" href="#">
                                   <div class="flex items-center -ms-1.5">
                                       <span
                                           class="bg-red-400/10 text-red-400 flex justify-center items-center w-8 h-8 shadow rounded me-3">
                                           <svg width="24px" height="24px" viewBox="0 0 24 24"
                                               version="1.1" xmlns="http://www.w3.org/2000/svg"
                                               ...
                                               <desc>Created with Sketch.</desc>
                                               <g id="Stockholm-icons-/-General-/-Like" stroke="none"
                                                   stroke-width="1" fill="none" fill-rule="evenodd">
                                                   <rect id="bound" x="0" y="0" width="24"
                                                       height="24"></rect>
                                                   <path
                                                       ...
                                                       id="Path-42" fill="currentColor"></path>
                                                   <rect id="Rectangle-153" fill="currentColor" opacity="0.3"
                                                       x="2" y="9" width="5" height="11" rx="1">
                                                   </rect>
                                               </g>
                                           </svg>
                                       </span>
                           ...
                           <div
                               class="w-full bg-slate-100 inline-flex items-center justify-center text-sm text-gray-800 py-1.5 px-3">
                               View All</div>
                       </div>
                   </li>
...
<!-- =========== Navbar End =========== -->
    ...
    <div class="bg-slate-100 h-full mt-[77px]  py-3 px-3">
        <section class="relative overflow-hidden">
            <div class="container">
                <div class="flex">
                    <div class="w-full">
                        <h3 class="text-xl text-gray-800 mt-2">Company Settings</h3>
                        <p class="mt-1 font-medium mb-4">Change your account settings</p>
                    </div>
                </div>
                                ...
                                <div class="grid lg:grid-cols-4 gap-6" data-fc-type="tab">
                                    ...
                                    <div class="lg:col-span-3 transition-all px-4 h-full">
                                        <div id="account" class="min-h-[650px]">
                                            <h4 class="text-base text-gray-800">Company Information</h4>

                                            <form action="{{ route('settings') }}" class="" method="POST">
                                                ...
                                                <div class="grid grid-cols-2 items-center gap-6">
                                                    <div class="">
                                                        <div class="mb-4">
                                                            <label for="name" class="block text-sm font-semibold mb-1 text-gray-600">Official Name<small>*</small></label>
                                                            <input type="text" class="py-2 px-4 leading-6 block w-full text-gray-700 border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="name" placeholder="Your Name" name="company_name" value="{{ $company->name }}">
                                                        </div>

                                                        <div class="mb-4">
                                                            <label for="email" class="block text-sm font-semibold mb-1 text-gray-600">Official Email<small>*</small></label>
                                                            <input type="email" class="py-2 px-4 leading-6 block w-full text-gray-700 border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="email" placeholder="Email" name="email" value="{{ $company->email }}">
                                                        </div>
                                                    </div>

                                                    <div class="">
                                                        <div class="mb-4">
                                                            <label for="display_name" class="block text-sm font-semibold mb-1 text-gray-600">API Key</label>
                                                            <input type="text" class="py-2 px-4 leading-6 block w-full text-gray-700 border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="display_name" aria-describedby="display_name" placeholder="Display Name" name="company_api" value="{{ $company->api_key }}">
                                                        </div>

                                                        <div class="mb-4">
                                                            <label class="block text-sm font-semibold mb-1 text-gray-600">Address<small>*</small></label>
                                                            <input type="text" class="py-2 px-4 leading-6 block w-full text-gray-700 border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" id="phone" name="company_address" placeholder="Phone number" value="{{ $company->address }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- basic info end -->
                                                ...
                                                <div class="flex mt-3">
                                                    <div class="w-full">
                                                        <button type="submit" class="inline-flex items-center justify-center py-3 px-4 rounded-lg text-sm font-semibold transition-all hover:shadow-lg bg-primary text-white hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 ">Save Changes</button>
                                                    </div>
                                                </div>
                                                <!-- save end -->
                                            </form>
    ...
    <section class="bg-white py-6 start-0 end-0">
        <div class="container">
